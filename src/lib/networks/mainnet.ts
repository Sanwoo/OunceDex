...
import { SupportedWrapHandler } from '../swap'
...
const networkConfig = {
  ...
  pools: convertHexToLowerCase({
    issues: {
      [PoolIssue.PoolProtocolFeeVulnWarning]: ['0x5b3240b6be3e7487d61cd1afdfc7fe4fa1d81e6400000000000000000000037b'],
      [PoolIssue.PoolOwnerVulnWarningGovernanceMigrate]: ['0x06df3b2bbb68adc8b0e302443692037ed9f91b42000000000000000000000063'],
      [PoolIssue.PoolOwnerVulnWarningGovernanceWithdraw]: ['0x7b50775383d3d6f0215a8f290f2c9e2eebbeceb20000000000000000000000fe'],
      [PoolIssue.PoolOwnerVulnWarningGovernance]: ['0x9f19a375709baf0e8e35c2c5c65aca676c4c719100000000000000000000006e'],
      ...
      [PoolIssue.RenBTCWarning]: ['0xfeadd389a5c427952d8fdb8057d6c8ba1156cc56000000000000000000000066', '0xad6a8c18b62eb914604ec1eec7fbcf132799fe090001000000000000000003f6'],
      [PoolIssue.EulerBoostedWarning]: ['0x50cf90b954958480b8df7958a9e965752f62712400000000000000000000046f'],

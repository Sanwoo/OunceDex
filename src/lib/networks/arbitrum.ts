...
const networkConfig = {
  ...
  pools: convertHexToLowerCase({
    issues: {
      [PoolIssue.PoolOwnerVulnWarningGovernance]: ['0x5a5884fc31948d59df2aeccca143de900d49e1a300000000000000000000006f'],
      [PoolIssue.PoolOwnerVulnWarningEcosystem]: ['0x0510ccf9eb3ab03c1508d3b9769e8ee2cfd6fdcf00000000000000000000005d'],
